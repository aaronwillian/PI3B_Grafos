...
# Iniciar Labirinto
inicio_lab = iniciar_labirinto('very-large-maze', 'Aaron') #Troca
visitados = set()
...
while pilha:
    ...
    mov_lab = movimentar_labirinto('very-large-maze', 'Aaron', posicao_atual) #Troca
    ...
    if all(movimento in visitados for movimento in movimentos):
        ...
        movimentar_labirinto('very-large-maze', 'Aaron', posicao_atual) #Troca 
...
def dfs_retrocesso(posicao_atual, visitados, caminho):
    caminho.append(posicao_atual)
    visitados.add(posicao_atual)
    mov_lab = movimentar_labirinto('very-large-maze', 'Aaron', posicao_atual)['movimentos'] #Troca
